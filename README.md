...
Projeto que simula um blog. Este projeto realiza requisições, porém, não altera o banco de dados. Em um cenário diferente, os endpoints se apresentam conforme exigido pela documentação, executariam instruções e alterariam essa base.
